...
test_output_file = open("sub4_mlp.csv", "w")
...
X_train, X_test = normalize_data(train_features, test_features, type='minmax')
y2 = train_labels
...
for index, image in enumerate(test_images):
    test_output_file.write(test_images_names[index] + "," + str(int(predict[index])) + "\n")
